      ...
      <header className="bg-gradient-to-r from-teal-100 to-teal-50 border-b border-teal-200 px-8 py-3">
        <div className="flex justify-between items-center">
          ...
          <nav className="flex gap-8 text-gray-700 font-medium text-sm">
            ...
            <Link to="/admin" className="text-teal-700 font-semibold">Admin</Link>
          </nav>
          ...
          <div className="lg:col-span-1">
            <div className="bg-teal-200/80 rounded-2xl p-5 shadow-sm">
              ...
              <nav className="space-y-1">
                ...
                <Link to="/complaints" className="flex items-center gap-3 px-3 py-2 text-gray-700 rounded-lg hover:bg-teal-300/40 transition font-medium text-sm">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  <span className="underline">Complaints</span>
                </Link>
                <Link to="/users" className="flex items-center gap-3 px-3 py-2 text-gray-700 rounded-lg hover:bg-teal-300/40 transition font-medium text-sm">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
